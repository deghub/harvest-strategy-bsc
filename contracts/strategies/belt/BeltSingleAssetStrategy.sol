...
contract BeltSingleAssetStrategy is BaseUpgradeableStrategy {
  ...
  function initialize(
    ...
    // require(IMultiStrategyToken(rewardPool()).token == underlying(), "Pool Info does not match underlying");
  }
